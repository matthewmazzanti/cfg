  ...
  config.home = {
    ...
    file = {
      ".config/rofi/config.rasi".text = ''
        configuration {
            modi: "window,run,ssh";
            run-command: "systemd-run --property="EnvironmentFile=/home/mmazzanti/.config/environment.d/10-home-manager.conf" --user {cmd}";
            dpi: 0;
        }
      ...
      ".config/rofi/theme.rasi".text = ''
        ...
        * {
            /* Theme settings */
            highlight: bold #8ec07c;
            scrollbar: false;

            /* Gruvbox dark colors */
            gruvbox-dark-bg0-hard:     argb:601d2021;
            gruvbox-dark-bg0:          argb:60282828;
            gruvbox-dark-bg2:          argb:60504945;
