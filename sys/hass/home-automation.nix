    ...
    containers = {
      nginx = {
        ...
        containerConfig = {
          ...
          pod = "ha.pod";
          image =
            "docker.io/nginxinc/nginx-unprivileged:alpine-slim@sha256:ca2305d71219043ad4cdf91d588b5a4f94d6bc3cd44bfd8667cee0b6c121b712";
          dropCapabilities = ["ALL"];
          addCapabilities = [ "CHOWN" "NET_BIND_SERVICE" ];
